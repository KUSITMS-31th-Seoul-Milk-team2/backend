...
//        log.info("ocrResponse: {}", ocrResponse);

        OcrValidationRequest ocrValidationRequest = OcrResponseConverter.convert(empPk, fileUrl, ocrResponse);
//        log.info("ocrValidationRequest: {}", ocrValidationRequest);
...
//        log.info("file in executeOcr: {}", file.getOriginalFilename());
